...
COPY ./pop.sql /docker-entrypoint-initdb.d/100_populate_source_source_daimon.sql
...
# COPY ./999_rename_and_create_db.sql /docker-entrypoint-initdb.d/999_rename_and_create_db.sql
